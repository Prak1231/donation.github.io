 ...
 <div class="container " style="padding:20px; background-color:whitesmoke;">
     <div class="row">
         ...
         <div class="col-sm-6 col-md-6 col-xl-6 col-lg-6">
             <form method="POST">
         <h4 class="text-primary font-weight-bold">FOOD DONATION</h4>
         <hr>
                ...
                <input type="hidden" name="user_id" value="<?php echo $user_id;?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="email" class="form-control" value="<?php echo $row['email'];?>" required="required" readonly/></div>
                        </div>
                        <div class="form-group">
                            <label for="name">
                                Address</label>
